...
import { adminService, getTodayVoice, getWeeklyVoice, getLanguageStats } from "../api/services";
...
export default function Dashboard() {
  ...
  const loadDashboard = async () => {
    ...
    try {
      const todayRes = await getTodayVoice();
    const weeklyRes = await getWeeklyVoice();
    const langRes = await getLanguageStats();
    const dashboardData = await adminService.getDashboard();
    setStats(dashboardData);
    setToday(todayRes.count);
    setWeekly(weeklyRes);
